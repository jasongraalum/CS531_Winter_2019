...
#ifdef _WTIME
#define _START_WTIME t1 = MPI_Wtime();
#define _END_WTIME t2 = MPI_Wtime();
#define _RPT_WTIME(NAME) printf("%s, %d, %s, %f, %f, %f\n", NAME, id, myHostName, t2, t1, t2-t1);
#else
#define _START_WTIME 
#define _END_WTIME 
#define _RPT_WTIME(name)
   // name 
#endif

...
void *thread_loop_fine_mutex(void *);

void multi_thread_global_fine_mutex(size_t iterations, size_t number, size_t nthreads, size_t cache_line_size, char verbosity)
{
    ...
    for (int it = 0; it < iterations; it++) {
        ...
        for(size_t t = 0; t < nthreads; t++)
        {
            ...
            pthread_create(&tid[t*cache_line_size], NULL, thread_loop_fine_mutex, &slice_count[t*cache_line_size]);
        }
